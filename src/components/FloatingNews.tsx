...
export default function FloatingNews() {
    ...
    return (
        <>
            {/* Botão flutuante - Posicionado abaixo do Top3 (top-6 + h-16 + gap) */}
            <button
                onClick={() => !isOpen ? handleOpen() : handleClose()}
                className="fixed top-28 right-6 w-16 h-16 rounded-full glass-dark shadow-xl hover:scale-105 transition-all flex items-center justify-center text-3xl z-40 border-2 border-sky-400/30 text-sky-400"
